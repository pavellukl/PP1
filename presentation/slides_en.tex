...
\begin{frame}
  \frametitle{Our Scope: NL $\rightarrow$ Formalism Translation}
  \centering
  \resizebox{\textwidth}{!}{%
  \begin{tikzpicture}[
...
\begin{frame}
  ...
  We found JSON better on a 14B local model.
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \bigskip
    \item \textbf{Fine-tuning} — can we accumulate corrections and improve over time?
